...
def login_page():
    ...
    st.write("""
    - AI-Generated Content: DevGenius app utilizes Amazon Nova via Bedrock to generate responses. While we strive for accuracy, the information provided may not always be complete, up-to-date, or error-free.
...
def create_option_tabs():
    ...
    tabs = st.tabs(["Cost Estimates", "Architecture diagram", "CDK code", "CloudFormation code", "Terraform code", "Technical documentation", "Project Backlog"])  # noqa
    return tabs


def create_architecture_analysis_tabs():
    """Create and return the Streamlit tabs for architecture analysis options."""
    tabs = st.tabs(["Architecture Analysis", "Project Backlog", "Cost Estimates", "Architecture diagram", "CDK code", "CloudFormation code", "Terraform code", "Technical documentation"])  # noqa
    return tabs
