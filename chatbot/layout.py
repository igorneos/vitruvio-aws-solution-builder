...
def login_page():
    ...
    # Main page content
    st.markdown("<h1 style='text-align: center;'>Welcome to Vitruvio App</h1>", unsafe_allow_html=True)

    # Description section
    st.header("Description")
    st.write("""
    Vitruvio is your AI-powered companion for AWS solution architecture, designed to streamline and enhance your cloud development process. Our innovative platform empowers you to effortlessly design AWS architectures tailored to your specific requirements, ensuring that your cloud infrastructure aligns perfectly with your project goals. 
    With Vitruvio, you can seamlessly generate infrastructure as code using powerful tools like AWS CDK and AWS CloudFormation, enabling faster deployment and easier management of your cloud resources. We also provide accurate cost estimates for AWS resources, helping you optimize your budget and make informed decisions. Moreover, Vitruvio adheres to AWS Well-Architected best practices, ensuring that your solutions are not only efficient and cost-effective but also secure, reliable, and operationally excellent. 

    Whether you're a seasoned AWS professional or just starting your cloud journey, Vitruvio is your go-to tool for building robust, scalable, and innovative AWS solutions.
    """)  # noqa
    ...
    st.write("""
    - AI-Generated Content: Vitruvio app utilizes uses Claude via Bedrock to generate responses. While we strive for accuracy, the information provided may not always be complete, up-to-date, or error-free.

    - Not a Substitute for Professional Advice: The responses generated by Vitruvio should not be considered as professional, legal, medical, financial, or expert advice. Always consult with qualified professionals for specific guidance in these areas.
    ...
    - Privacy and Data Usage: User interactions with Vitruvio may be logged and analyzed for improvement purposes.
    ...
    - Disclaimer of Liability: AWS is not liable for any damages or losses resulting from the use of or reliance on information provided by Vitruvio.
    - User Responsibility: Users are responsible for evaluating the appropriateness and accuracy of the Vitruvio's responses for their specific needs and circumstances.
    ...
    By using this Vitruvio, you acknowledge that you have read, understood, and agreed to this disclaimer.
    """)  # noqa
...
def welcome_sidebar():
    ...
    with logo_col:
        # st.image("images/Vitruvio.JPG", width=150)
        st.title("✨ Vitruvio App")
...
def create_option_tabs():
    """Create and return the Streamlit tabs for the various options supported by Vitruvio."""
